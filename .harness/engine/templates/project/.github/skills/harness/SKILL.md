...
This repository vendors its reusable harness at `.harness/engine`.
...
1. Verify `.harness/engine/skills/build-feature/SKILL.md` exists. If it does not, stop and report that
   the committed harness snapshot is missing or incomplete.
